...
#include "TCP/TestAsio/Server/AsioSimpleServer.h"
#include "TCP/TestAsio/Client/AsioClient.h"
...
//	//	Network::Peer::AbstarctPeer<string>* testPeer = new Network::Peer::P2pPeer<string>();
//	//	cin.ignore();
//	//}
//	//else if (arg > 1)
//	//{	
//		/*char *command = argv[1];
//		cout << command << endl;
//		if (0 == strcmp(help.c_str(), command))
//		{
//			cout << "please enter the ip address alone" << endl;
//			cout << "Or enter in conjunction to the index of the peer" << endl;
//		}
//		else*/
//		//{
//			if (arg <= 1)
...
//				string name = argv[2];
//				Network::Peer::Testing::TestingFramework<string> *currentPeer = new Network::Peer::Testing::TestingFramework<string>(ipAddress, 100, name);*/
//
//				Network::Communication::SimpleTestServer testServer;
//
//			}
//			else if (arg > 1)
//			{
//				/*string ipAddress = argv[1];
//				string name = argv[4];
//				int socketNumber = std::stoi(string(argv[2]));
//				int sequenceNumber = std::stoi(string(argv[3]));
//*/
//				//Network::Peer::AbstarctPeer<string> *currentPeer = new Network::Peer::P2pPeer<string>(ipAddress, socketNumber,sequenceNumber, name);
//				////currentPeer->RunUpdateProcedure();
//				Network::Communication::TestClient testClient;
//				system("pause");
//			}
//		//}
//		
...
//
//	Network::ObservableEvents::ObservableEvent<string>* testObservableEvent = new Network::ObservableEvents::ObservableEvent<string>(testVectorTimer, "a", 0);
//	
//	BOOST_CHECK("a", testObservableEvent->GetStringUpdate());
//	string tetsObservableEventOutput = testObservableEvent->ToString();
//	Network::ObservableEvents::ObservableEvent<string>* secondObservableEvent = new Network::ObservableEvents::ObservableEvent<string>();
...
//// ----------------------------------------------------------------------
//
//#include "Debug\MessageIdentifiers.h"
//
//#include "Debug\RakPeerInterface.h"
//#include "Debug\RakNetStatistics.h"
//#include "Debug\RakNetTypes.h"
//#include "Debug\BitStream.h"
//#include "Debug\RakSleep.h"
//#include "Debug\PacketLogger.h"
//#include <assert.h>
//#include <cstdio>
//#include <cstring>
//#include <stdlib.h>
...
//}
#pragma endregion old sample code